...
We currently support alerting from PagerDuty, StatusCake, Prometheus, New Relic, and Opsgenie. If you are using a custom tool, the tool must be configured to send HTTP POST requests to the endpoint documented [here](api-reference/endpoints/issues/create_issue).
