...
To integrate with New Relic, fill out the indicated fields.

<img height="70" src="/images/add_new_relic_integration.png" />

Once integrated, to receive alerts from New Relic, select New Relic when creating a project and follow the instructions to allow alerts to be sent to that project.

<img height="70" src="/images/new_relic_instructions.png" />
