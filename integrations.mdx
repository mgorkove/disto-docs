...
To integrate with Datadog, add your Datadog site URL and create an API key and application key as indicated below. 

<img height="70" src="/images/datadog1.png" />
<img height="70" src="/images/datadog2.png" />

## Loggly

To integrate with Loggly, add your Loggly subdomain and create an API key as indicated below. 

<img height="70" src="/images/loggly1.png" />

## Google Cloud

To integrate with Google Cloud, create a service account and create and upload the private key to Disto as indicated below. 

<img height="70" src="/images/gcp1.png" />
<img height="70" src="/images/gcp2.png" />

## AWS

To integrate with AWS, create a CloudFormation stack with a read only IAM role and upload the Role ARN to Disto as indicated below. 

<img height="70" src="/images/aws1.png" />
